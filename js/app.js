...
var dates = [
  //        Pay Period       |   Approval  |   Pay Date   |
  ["07/28/2020", "08/16/2020", "08/18/2020", "08/31/2020"],
  ["08/17/2020", "08/30/2020", "09/01/2020", "09/15/2020"],
  ["08/31/2020", "09/13/2020", "09/15/2020", "09/30/2020"],
  ["09/14/2020", "09/27/2020", "09/29/2020", "10/15/2020"],
  ["09/28/2020", "10/18/2020", "10/20/2020", "10/30/2020"],
  ["10/19/2020", "11/01/2020", "11/03/2020", "11/13/2020"],
  ["11/02/2020", "11/15/2020", "11/17/2020", "11/30/2020"],
  ["11/16/2020", "11/29/2020", "12/01/2020", "12/15/2020"],
  ["11/30/2020", "12/13/2020", "12/15/2020", "12/31/2020"],
  ["12/14/2020", "12/27/2020", "12/29/2020", "01/15/2020"],
  ["12/28/2020", "01/10/2021", "01/12/2021", "01/29/2021"],
  ["01/11/2021", "01/24/2021", "01/26/2021", "02/12/2021"],
  ["01/25/2021", "02/14/2021", "02/16/2021", "02/26/2021"],
  ["02/15/2021", "02/28/2021", "03/02/2021", "03/15/2021"],
  ["03/01/2021", "03/14/2021", "03/16/2021", "03/31/2021"],
  ["03/15/2021", "03/28/2021", "03/30/2021", "04/15/2021"],
  ["03/29/2021", "04/11/2021", "04/13/2021", "04/30/2021"],
  ["04/12/2021", "04/25/2021", "04/27/2021", "05/14/2021"],
  ["04/26/2021", "05/16/2021", "05/18/2021", "05/28/2021"],
  ["05/17/2021", "05/30/2021", "06/01/2021", "06/15/2021"],
  ["05/31/2021", "06/13/2021", "06/15/2021", "06/30/2021"],
  ["06/14/2021", "07/04/2021", "07/06/2021", "07/15/2021"],
  ["07/05/2021", "07/18/2021", "07/20/2021", "07/30/2021"],
  ["07/19/2021", "07/31/2021", "08/02/2021", "08/13/2021"],
];
...
$(window).on("load", function () {
  ...
  x.change(function () {
    if ($(this).val() == "period1") {
      $("#submitdate1").html("08/18/2020");
      $("#submitdate2").html("08/31/2020");
      filldays("2020-07-27");
    }
    if ($(this).val() == "period2") {
      $("#submitdate1").html("08/01/2020");
      $("#submitdate2").html("09/15/2020");
      filldays("2020-08-17");
    }
    if ($(this).val() == "period3") {
      $("#submitdate1").html("09/15/2020");
      $("#submitdate2").html("09/30/2020");
      filldays("2020-08-31");
    }
    if ($(this).val() == "period4") {
      $("#submitdate1").html("09/29/2020");
      $("#submitdate2").html("10/15/2020");
      filldays("2020-09-14");
    }
    if ($(this).val() == "period5") {
      $("#submitdate1").html("10/20/2020");
      $("#submitdate2").html("10/30/2020");
      filldays("2020-09-28");
    }
    if ($(this).val() == "period6") {
      $("#submitdate1").html("11/03/2020");
      $("#submitdate2").html("11/13/2020");
      filldays("2020-10-19");
    }
    if ($(this).val() == "period7") {
      $("#submitdate1").html("11/17/2020");
      $("#submitdate2").html("11/30/2020");
      filldays("2020-11-02");
    }
    if ($(this).val() == "period8") {
      $("#submitdate1").html("12/01/2020");
      $("#submitdate2").html("12/15/2020");
      filldays("2020-11-16");
    }
    if ($(this).val() == "period9") {
      $("#submitdate1").html("12/15/2020");
      $("#submitdate2").html("12/31/2020");
      filldays("2020-11-30");
    }
    if ($(this).val() == "period10") {
      $("#submitdate1").html("12/29/2021");
      $("#submitdate2").html("01/15/2021");
      filldays("2020-12-14");
    }
    if ($(this).val() == "period11") {
      $("#submitdate1").html("01/12/2021");
      $("#submitdate2").html("01/29/2021");
      filldays("2020-12-28");
    }
    if ($(this).val() == "period12") {
      $("#submitdate1").html("01/26/2021");
      $("#submitdate2").html("02/12/2021");
      filldays("2021-01-11");
    }
    if ($(this).val() == "period13") {
      $("#submitdate1").html("02/16/2021");
      $("#submitdate2").html("02/26/2021");
      filldays("2021-01-25");
    }
    if ($(this).val() == "period14") {
      $("#submitdate1").html("03/02/2021");
      $("#submitdate2").html("03/15/2021");
      filldays("2021-02-15");
    }
    if ($(this).val() == "period15") {
      $("#submitdate1").html("03/16/2021");
      $("#submitdate2").html("03/31/2021");
      filldays("2021-03-01");
    }
    if ($(this).val() == "period16") {
      $("#submitdate1").html("03/30/2021");
      $("#submitdate2").html("04/15/2021");
      filldays("2021-03-15");
    }
    if ($(this).val() == "period17") {
      $("#submitdate1").html("04/13/2021");
      $("#submitdate2").html("04/30/2021");
      filldays("2021-03-29");
    }
    if ($(this).val() == "period18") {
      $("#submitdate1").html("04/27/2021");
      $("#submitdate2").html("05/14/2021");
      filldays("2021-04-12");
    }
    if ($(this).val() == "period19") {
      $("#submitdate1").html("05/18/2021");
      $("#submitdate2").html("05/28/2021");
      filldays("2021-04-26");
    }
    if ($(this).val() == "period20") {
      $("#submitdate1").html("06/01/2021");
      $("#submitdate2").html("06/15/2021");
      filldays("2021-05-17");
    }
    if ($(this).val() == "period21") {
      $("#submitdate1").html("06/15/2021");
      $("#submitdate2").html("06/30/2021");
      filldays("2021-05-31");
    }
    if ($(this).val() == "period22") {
      $("#submitdate1").html("07/06/2021");
      $("#submitdate2").html("07/15/2021");
      filldays("2021-06-14");
    }
    if ($(this).val() == "period23") {
      $("#submitdate1").html("07/20/2021");
      $("#submitdate2").html("07/30/2021");
      filldays("2021-07-05");
    }
    if ($(this).val() == "period24") {
      $("#submitdate1").html("08/02/2021");
      $("#submitdate2").html("08/13/2021");
      filldays("2021-07-19");
    }
    calculate();
    $(".holidayWarning").show();
...
function addAsteriskToDate(dayNumber) {
  ...
  if (holiday_status) {
    $("#asterisk" + dayNumber).show();
  } else {
    $("#asterisk" + dayNumber).hide();
  }
...
function check_before_print() {
  ...
  for (i = 10; i < 31; i++) {
    ...
    if (check_break != NaN && check_break < 0) {
      alert(
        "You made a mistake on " + check_day + " entry. Click ok to correct it."
      );
      $("#out_1_" + i).focus();
      return;
    }
  ...
  if (
    name_field &&
    position_field != "Choose Position" &&
    campus_field != "Choose Campus"
  ) {
    window.print();
  } else {
    if (name_field && campus_field != "Choose Campus") {
      ...
      if (
        ...
        if (campus_field != "Choose Campus") {
          alert(
            "Please type your full name and choose job title before printing"
          );
          $("#fullname").focus();
        } else {
          if (
            ...
            alert(
              "Please choose your campus, position and type your name before printing"
            );
            $("#CampusSelector").focus();
          }
        }
...
function checkTooMuchHour() {
  ...
  for (i = 10; i < 31; i++) {
    ...
    if (check_daily_total != NaN && check_daily_total >= 10) {
      var toomuchHour = confirm(
        check_day +
          " shows " +
          check_daily_total +
          " hours of work. Click Cancel if you want to go back and check for a possible mistake. Or click OK to continue with printing."
      );
      if (toomuchHour) {
        window.print();
      } else {
...
function calculate() {
  ...
  for (i = 10; i < 31; i++) {
    ...
    if (ampm_in_1 == "AM") {
      if (hh_in_1 == 12) hh_in_1 = 0;
    }
    if (ampm_in_1 == "PM") {
      if (hh_in_1 != 12) hh_in_1 = hh_in_1 + 12;
    }

    if (ampm_out_1 == "AM") {
      if (hh_out_1 == 12) hh_out_1 = 0;
    }
    if (ampm_out_1 == "PM") {
      if (hh_out_1 != 12) hh_out_1 = hh_out_1 + 12;
    }

    if (ampm_in_2 == "AM") {
      if (hh_in_2 == 12) hh_in_2 = 0;
    }
    if (ampm_in_2 == "PM") {
      if (hh_in_2 != 12) hh_in_2 = hh_in_2 + 12;
    }

    if (ampm_out_2 == "AM") {
      if (hh_out_2 == 12) hh_out_2 = 0;
    }
    if (ampm_out_2 == "PM") {
      if (hh_out_2 != 12) hh_out_2 = hh_out_2 + 12;
    }
    ...
    if (ampm_in_1 && ampm_out_1 && ampm_in_2 && ampm_out_2) {
      time_diff = (time_out_2 - time_in_2 + (time_out_1 - time_in_1)) / 1000;
    } else {
      if (ampm_in_1 && ampm_out_1 && ampm_in_2) {
        time_diff = 0;
      } else {
        if (ampm_in_1 && ampm_out_1 && ampm_out_2) {
          time_diff = 0;
        } else {
          if (ampm_in_1 && ampm_in_2 && ampm_out_2) {
            time_diff = 0;
          } else {
            if (ampm_out_1 && ampm_in_2 && ampm_out_2) {
              time_diff = 0;
            } else {
              if (ampm_in_1 && ampm_out_1) {
                time_diff = (time_out_1 - time_in_1) / 1000;
              } else {
                if (ampm_in_1 && ampm_out_2) {
                  time_diff = (time_out_2 - time_in_1) / 1000;
                } else {
                  if (ampm_in_2 && ampm_out_2) {
                    time_diff = (time_out_2 - time_in_2) / 1000;
                  }
                }
              }
            }
    ...
    if (ampm_out_1 && ampm_in_2) {
      ...
      var break_diff_minutes = Math.floor(
        (break_diff - break_diff_hours * 3600) / 60
      );
    ...
    var time_diff_minutes = Math.floor(
      (time_diff - time_diff_hours * 3600) / 60
    );
    ...
    switch (true) {
      case time_diff_decimal == 0:
        dailyAbsence = 8;
        break;
      case time_diff_decimal > 0 && time_diff_decimal <= 2:
        dailyAbsence = 6;
        break;
      case time_diff_decimal > 2 && time_diff_decimal <= 4:
        dailyAbsence = 4;
        break;
      case time_diff_decimal > 4 && time_diff_decimal <= 6:
        dailyAbsence = 2;
        break;
      case time_diff_decimal > 6:
        dailyAbsence = 0;
        break;
    }
    ...
    if (
      jQuery("#PeriodSelector").val() != "period3" &&
      jQuery("#PeriodSelector").val() != "period9" &&
      jQuery("#PeriodSelector").val() != "period13" &&
      jQuery("#PeriodSelector").val() != "period21" &&
      jQuery("#PeriodSelector").val() != "period24"
    ) {
    ...
    if (i != 15 && i != 16 && i != 22 && i != 23 && i != 29 && i != 30) {
      ...
      var holiday_status_calc = document.getElementById("holiday" + dayCounter)
        .checked;
    ...
    if (
      daily_tardy > 0 &&
      time_diff_hours + time_diff_minutes / 60 < 8 &&
      daily_tardy < 1.83333333333333333333333333
    ) {
      // 1.83 is 1 hour 50 minutes. Tardy is calculated only if tardy is more than 10 minutes.
    ...
    if (i <= 16) {
      ...
      if (i != 15 && i != 16 && i != 22 && i != 23 && i != 29 && i != 30) {
        holiday_status_calc = document.getElementById("holiday" + dayCounter)
          .checked;
  ...
  week_1_unscheduled = Math.max(
    0,
    week_1_reg - week_1_scheduled + week_1_tardy + week_1_absence
  );
  week_2_unscheduled = Math.max(
    0,
    week_2_reg - week_2_scheduled + week_2_tardy + week_2_absence
  );
  week_3_unscheduled = Math.max(
    0,
    week_3_reg - week_3_scheduled + week_3_tardy + week_3_absence
  );

  overall_total_scheduled =
    week_1_scheduled + week_2_scheduled + week_3_scheduled;
  overall_total_unscheduled =
    week_1_unscheduled + week_2_unscheduled + week_3_unscheduled;
  console.clear();
